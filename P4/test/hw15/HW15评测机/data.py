...
parameterIsError = 0
attributeNameIsSame = 0.6
##########state diagram################
guardNameList = [' \t', '\t\t', 'wwdl', 'gpaGG', 'KaoYanQvLe', 'orzorzorz']
...
def generAttribute(nameIsBlank=False):
    global totalId
    if not classIdList:
    ...
    p = random.random()
    if p < attributeNameIsSame and classAttributeNameMap[parentId]:
